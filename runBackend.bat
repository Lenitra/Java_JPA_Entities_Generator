...
echo [4/5] Compilation de src/RunBackend.java...
"%JAVAC_EXEC%" -d "%BIN_DIR%" src/RunBackend.java
if errorlevel 1 (
...
echo [5/5] Exécution de la classe src/RunBackend...
"%JAVA_EXEC%" -XX:+ShowCodeDetailsInExceptionMessages -cp "%BIN_DIR%" RunBackend
